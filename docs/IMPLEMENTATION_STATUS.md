...
- Added claim race regression tests.
...
See `docs/TECH_DEBT.md` for the active list. Highest-priority items are missing marketplace item escrow, incomplete auction settlement, incomplete route/travel graph, and broader concurrency/idempotency tests.
